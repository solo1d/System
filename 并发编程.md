...
![](http://i.imgur.com/OVEqPpv.png)

* 服务器正在监听一个监听描述符\(`描述符3`\)上的连接请求
* 服务器接收`客户端1`的连接请求
* 并返回一个已连接描述符\(`描述符4`\)。

![](http://i.imgur.com/lpCP1ln.png)

* 子进程获得服务器描述符表的完整拷贝\(`描述符3,4`\)
* 子进程关闭它的拷贝中的`监听描述符3`
* 服务器关闭描述符表中的`描述符4`

![](http://i.imgur.com/2O37PqB.png)
